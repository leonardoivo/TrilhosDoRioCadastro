...
$retorno=0;
$paginaAtual=0;
$id_interessado= isset($_REQUEST['id_interessado'])?$_REQUEST['id_interessado']:0;
$exclusao = isset($_REQUEST['exclusao'])?$_REQUEST['exclusao']:false;
$numero_pagina =(isset($_GET['pagina']))? $_GET['pagina'] : 1; 


$TotalLinhas=$InteressadosLt->ListarTotais();
   ...
   <div class=\"collapse navbar-collapse\" id=\"conteudoNavbarSuportado\">
     <ul class=\"navbar-nav mr-auto\">
       <li class=\"nav-item active\">
         <a class=\"nav-link\" <a href=\"CadastroIn.php\">Cadastrar Interessado </a>
       </li>
       <li class=\"nav-item\">
...
//         // if(VerAcesso($usuario,$link)==true){
 ...
 <ul class=\"pagination\">
   <li class=\"page-item\">
     <a class=\"page-link\" href='Interessados.php?pagina=".$retorno."' aria-label=\"Anterior\">
   ...
   for ($i=1;1+$totalPaginas>$i;$i++)
   {
     // $paginaAtual=$i;
      ...
      // echo "<a href='Interessados.php?pagina=".$i."' class='numero ".$ativo."'> ".$i." </a>";
      if($ativo=='numativo'){
        echo  " <li class=\"page-item active\">
        <a class=\"page-link\" href='Interessados.php?pagina=".$i."' >".$i."<span class=\"sr-only\"></span></a>
  ...
  echo "<a class=\"page-link\" href='Interessados.php?pagina=".$avanco."' aria-label=\"Próximo\">
