...
<tr><td>Endereço:<input type="text" name="rua" id="endereco"></td><td>Numero:<input type="text" name="numero"></td><td> Complemento: <input type="text" name="Complemento"></td></tr>
<tr><td> Bairro:<input type="text" name="bairro" id="bairro"></td><td>Cidade: <input type="text" name="cidade" id="cidade"> </td><td>Estado: <input type="text" name="uf" id="estado"> </td><td>Pais: <input type="text" name="Pais"> </td></tr>
<tr><td>Data de Nascimento <input type="date" name="dataNascimento"></td><td> Naturalidade: <input type="text" name="Naturalidade"> </td></tr>
