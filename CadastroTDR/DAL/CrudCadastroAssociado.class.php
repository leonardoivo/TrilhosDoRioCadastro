...
class CrudCadastroAssociado extends Crud{
    ...
    public function GravarCadastroAssociado(CadastroAssociadoDTO $CadastroAssociadoDT)
    {
            ...
            $insertParte1="insert into cadastroAssociado (nome,sobrenome,data_De_nascimento,email,telefone,id_origem, endereco, cep, Bairro, Cidade, Estado,data_De_cadastro,pais,data_De_desligamento,forma_de_doacao, numero,complemento,cpf,interesses,naturalidade)";
            $insertParte2="values (:nome,:sobrenome,:data_De_nascimento,:email,:telefone,:id_origem,:endereco,:cep,:Bairro,:Cidade,:Estado,:data_De_cadastro,:pais,:data_De_desligamento,:forma_de_doacao,:numero,:complemento,:cpf,:interesses,:naturalidade)";
